...
<div x-data="{ modelOpen: false }">
    <button @click="modelOpen =!modelOpen" class="flex items-center m-auto justify-center px-6 py-6 space-x-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-green-600 rounded-md dark:bg-green-600 dark:hover:bg-green-700 dark:focus:bg-green-700 hover:bg-green-600 focus:outline-none focus:bg-green-500 focus:ring focus:ring-green-300 focus:ring-opacity-50">
        ...
        <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
            ...
            >
                <div class="flex items-center justify-between space-x-4">
                    <h1 class="text-xl font-medium text-gray-800 ">Invite Your Customers To Review It</h1>
                ...
                <p class="mt-2 text-sm text-gray-500 ">
                    The Link To This Product Is: <br> <code class="text-green-600">http://fast-eyrie-05303.herokuapp.com/product/{{$product->id}}</code>
                </p>
