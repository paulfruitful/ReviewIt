     ...
     <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
      ...
      <h1 class="text-center text-4xl font-bold mb-12">Login <span class="text-green-700">Now</span></h1>
         <form action="/login" method="POST">
           ...
           <button
             type="submit"
             class="inline-block px-7 py-3 bg-green-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-600-700 hover:shadow-lg focus:bg-green-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-800 active:shadow-lg transition duration-150 ease-in-out w-full"
